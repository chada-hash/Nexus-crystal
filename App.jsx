                ...
                <div style={{display:"flex",flexWrap:"wrap",gap:3,justifyContent:"center"}}>
                  {FR_KEYS.map(([fr,ar])=>(
                    <button key={fr} onClick={()=>setRootIn(p=>{
                      ...
                      style={{background:"rgba(232,201,122,.06)",border:"1px solid rgba(232,201,122,.2)",borderRadius:4,padding:"4px 5px",cursor:"pointer",minWidth:32,textAlign:"center"}}>
                      <div style={{fontSize:13,color:G,fontFamily:"Amiri,serif",lineHeight:1}}>{ar}</div>
                      <div style={{fontSize:6,color:"rgba(232,201,122,.45)",letterSpacing:1}}>{fr}</div>
                    </button>
                  ))}
